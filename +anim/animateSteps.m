function animateSteps( seq,speedfactor )
...
rf=seq.rTra;
bdy=seq.bdyTra;
 load('.\data\targets\targets_ordered.mat')%Loads the targets initial location and direction
 anim.drawDestination(double(all_targets(seq.targetNo,:))./[162 162 1],'m'); %Input is measured in cm and needed to be in mm. So *10
